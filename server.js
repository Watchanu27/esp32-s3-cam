...
// ไม่มีภาพใหม่เกิน 5 วินาที = Camera Offline
...
app.post('/upload', (req, res) => {
  ...
  if (distanceHeader !== undefined) {
    ...
    if (
      ...
      console.log(
        `📷 Frame received | 📦 Distance: ${distance} cm`
      );
...
// =====================================================
// VIEW SINGLE CAMERA FRAME
// =====================================================
//
// ยังเก็บไว้สำหรับทดสอบ
//
// /view
//
// =====================================================
...
// =====================================================
//
// Browser จะเปิด connection เดียว
// แล้ว Server ส่ง JPEG ใหม่เรื่อย ๆ
//
// /stream?key=changeme123
//
// =====================================================
...
async function updateStatus() {
  ...
  try {
    ...
    // IMPORTANT
    //
    // ไม่โหลด /view ซ้ำอีกแล้ว
    // เพราะใช้ MJPEG /stream
    // =================================================
