...
// =====================================================
// OFFLINE IMAGE
// ถ้ามี offline.png ให้ใช้ไฟล์นั้น
// ถ้าไม่มี จะใช้รูปสำรองอัตโนมัติ
// =====================================================

app.get('/offline.png', (req, res) => {

  const offlinePath = path.join(__dirname, 'offline.png');

  res.sendFile(offlinePath, (err) => {

    if (err) {

      // ถ้าไม่มี offline.png
      // สร้างภาพ SVG สำรองแทน
      res.status(200);
...
async function updateStatus() {
  ...
  try {
    ...
    // CAMERA IMAGE
    //
    // ไม่เปลี่ยน src ทุก 500ms
    // เพื่อป้องกันภาพกระพริบ
    // =================================================
